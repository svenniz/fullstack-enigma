    ...
    public static class SeedData
    {
        public static void SeedRealData(EnigmaDbContext context)
        {
            if (!context.Cards.Any())
            {
                ...
                {
                    // Black Lotus images
                    new Image { CardId = blackLotus.Id, Url = "https://cards.scryfall.io/normal/front/4/a/4a2e428c-dd25-484c-bbc8-2d6ce10ef42c.jpg?1559591808", AltText = "Black Lotus - Original Art"},
                    new Image { CardId = blackLotus.Id, Url = "https://cards.scryfall.io/normal/front/b/d/bd8fa327-dd41-4737-8f19-2cf5eb1f7cdd.jpg?1614638838", AltText = "Black Lotus - Alternate Art"},

                    // Lightning Bolt images
                    new Image { CardId = lightningBolt.Id, Url = "https://cards.scryfall.io/normal/front/d/5/d573ef03-4730-45aa-93dd-e45ac1dbaf4a.jpg?1559591645", AltText = "Lightning Bolt - Original Art"},
                    new Image { CardId = lightningBolt.Id, Url = "https://cards.scryfall.io/normal/front/7/7/77c6fa74-5543-42ac-9ead-0e890b188e99.jpg?1706239968", AltText = "Lightning Bolt - Promo"},

                    // Serra Angel images
                    new Image { CardId = serraAngel.Id, Url = "https://cards.scryfall.io/normal/front/f/8/f8ac5006-91bd-4803-93da-f87cf196dd2f.jpg?1559591394", AltText = "Serra Angel - Original Alpha Art"},
                    new Image { CardId = serraAngel.Id, Url = "https://cards.scryfall.io/normal/front/3/c/3cee9303-9d65-45a2-93d4-ef4aba59141b.jpg?1730489152", AltText = "Serra Angel - Foundations Art"},

                    // Counterspell images
                    new Image { CardId = counterspell.Id, Url = "https://cards.scryfall.io/normal/front/7/c/7c666b4b-c4ff-40ca-9d16-c76aafebaa83.jpg?1559592109", AltText = "Counterspell - Original Art"},
                    new Image { CardId = counterspell.Id, Url = "https://cards.scryfall.io/normal/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907", AltText = "Counterspell - Duskmourn Commander"}
                });
                context.SaveChanges();
            }
